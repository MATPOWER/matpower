function [Gaa, Gav, Gva, Gvv] = d2Sbus_dV2_P(Ybus, V, lam)
%d2Sbus_dV2_P   Computes 2nd derivatives of power injection w.r.t. voltage.
%   [GAA, GAV, GVA, GVV] = d2Sbus_dV2_P(YBUS, V, LAM) returns 4 matrices
...
%       [Gaa, Gav, Gva, Gvv] = d2Sbus_dV2_P(Ybus, V, lam);
%
