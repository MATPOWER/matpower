function [dSf_dVa, dSf_dVm, dSt_dVa, dSt_dVm, Sf, St] = dSbr_dV_P(branch, Yf, Yt, V)
%dSbr_dV_P   Computes partial derivatives of power flows w.r.t. voltage.
%   [DSF_DVA, DSF_DVM, DST_DVA, DST_DVM, SF, ST] = dSbr_dV_P(BRANCH, YF, YT, V)
