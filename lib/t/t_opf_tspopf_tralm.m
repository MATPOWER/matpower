...
% t_opf_tspopf_tralm - Tests for legacy TRALM-based optimal power flow.
...
if have_feature('tralmopf')
    ...
    t_is(r.x, xr, 8, [t [t 'raw x returned from OPF']]);
