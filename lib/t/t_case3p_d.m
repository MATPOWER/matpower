function mpc = t_case3p_d
% t_case3p_d - Six bus hybrid test case, 2 single-phase buses, 4 3-phase buses.
%
% One bus is a hybrid PV bus (PV on 3-phase side). Three phase bus
...
mpc.bus = [
	1	3	0	0	0	0	1	1	0.00361724	12.47	1	1.1	0.9;
