function [success, err_list] = generate_autodoc_stubs(in, dest, escape_plus)
% generate_autodoc_stubs - Generate source .rst stubs for Reference Manual.
% ::
%
%   generate_autodoc_stubs(in, dest)
%   generate_autodoc_stubs(in, dest, escape_plus)
%
%   % not yet implemented
...
%                               (w/o .m extension)
%           escape_plus         escape '+' in paths in source URLs if true,
%                               default is false
%
