...
%               .rel_link2src   relative path of the original source directory
%                               from the (dest)
%               .list           struct array
