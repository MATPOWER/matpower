function mpc = t_case3p_e
% t_case3p_e - Five bus hybrid test case, 1 single-phase bus, 4 3-phase buses.
%
% One bus is a hybrid REF bus (REF on single-phase side). Three phase bus
