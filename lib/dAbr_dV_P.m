function [dAf_dVa, dAf_dVm, dAt_dVa, dAt_dVm] = ...
                        dAbr_dV_P(dSf_dVa, dSf_dVm, dSt_dVa, dSt_dVm, Sf, St)
%dAbr_dV_P   Partial derivatives of squared flow magnitudes w.r.t voltage.
...
%       [dFf_dVa, dFf_dVm, dFt_dVa, dFt_dVm, Ff, Ft] = ...
%               dSbr_dV_P(branch(il,:), Yf, Yt, V);
%       [dAf_dVa, dAf_dVm, dAt_dVa, dAt_dVm] = ...
%               dAbr_dV_C(dFf_dVa, dFf_dVm, dFt_dVa, dFt_dVm, Ff, Ft);
%
