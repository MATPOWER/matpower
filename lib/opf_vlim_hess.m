...
%   D2VLIMS = OPF_VLIM_HESS(X, LAMBDA, REF, MPOPT)
%
...
if nlam
    ...
    lamUp = zeros(0,1);   %% (required to avoid problems when using Knitro
    lamLow = zeros(0,1);   %%  on cases with all lines unconstrained)    
end
...
%% construct Hessian
d2Vlims = -[ VlimU_ii VlimU_ir; VlimU_ri VlimU_rr] + [ VlimL_ii VlimL_ir; VlimL_ri VlimL_rr];     
