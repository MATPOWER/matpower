function [dSbus_dVm, dSbus_dVa] = dSbus_dV_P(Ybus, V)
%dSbus_dV_P   Computes partial derivatives of power injection w.r.t. voltage.
%   [DSBUS_DVM, DSBUS_DVA] = dSbus_dV_P(YBUS, V) returns two matrices containing
...
%       [dSbus_dVm, dSbus_dVa] = dSbus_dV_P(Ybus, V);
%
