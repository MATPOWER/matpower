...
%D2ASBR_DV2   Computes 2nd derivatives of current magnitude^2 w.r.t. voltage.
...
%	derivatives of the square of the magnitude of the branch power flows.
...
diagSbr_conj = spdiags(conj(Sbr), 0, nl, nl);
