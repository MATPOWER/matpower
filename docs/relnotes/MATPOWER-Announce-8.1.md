...
- single-phase to three-phase conversion capabilities [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=MATPOWER/matpower&branch=ci-testing&file=examples/convert_1p_to_3p_ex1.mlx)
- using new `mp.opt_model` class to build and solve an optimization model [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=MATPOWER/matpower&branch=ci-testing&file=mp-opt-model/examples/milp_ex1.mlx)
- new quadratic constraint features and QCQP features [![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=MATPOWER/matpower&branch=ci-testing&file=mp-opt-model/examples/qcqp_example1.mlx)
