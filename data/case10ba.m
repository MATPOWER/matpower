...
%CASE10ba  Power flow data for 10 bus distribution system from Baghzouz and
%    Ertem, 
%    Please see CASEFORMAT for details on the case file format.
%
%    Data from ...
%    Baghzouz Y, Ertem S., ìShunt capacitor sizing for radial
%    distribution feeders with distorted substation voltagesî,
