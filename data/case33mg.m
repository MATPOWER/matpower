...
%CASE33mg  Power flow data for 33 bus distribution system from M. A.
%          Kashem, V. Ganapathy, G. B. Jasmon & M. Buhari
%    Please see CASEFORMAT for details on the case file format.
%
%    Data from ... M. A. Kashem, V. Ganapathy, G. B. Jasmon & M. Buhari, "A
...
mpc.branch = [  %% (r and x specified in ohms here, converted to p.u. below)
	...
	7	8	1.7114	1.2351	0	0	0	0	0	0	1	-360	360; % in some refences 0.71 and 0.23
