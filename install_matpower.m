...
install = struct( ...
    ...
    'dirs', { ...       %% directories to add to path
        {{'lib'}, {'lib', 't'}, {'data'}, {'examples'}}, ...
        {{'most', 'lib'}, {'most', 'lib', 't'}, {'most', 'examples'}}, ...
        {{'mp-opt-model', 'lib'}, {'mp-opt-model', 'lib', 't'}, ...
            {'mp-opt-model', 'examples'}}, ...
        {{'mips', 'lib'}, {'mips', 'lib', 't'}, {'mips', 'examples'}}, ...
    ...
    'fcns', { ...       %% functions to search for to find old paths to remove
        {'mpver', 'test_matpower', 'case9', 'cpf_example'}, ...
        {'mostver', 'test_most', 'most_ex6_uc'}, ...
        {'mpomver', 'test_mp_opt_model', 'qp_ex1'}, ...
        {'mipsver', 'test_mips', 'mips_example1'}, ...
        {'t_begin', 'test_mptest'}, ...
